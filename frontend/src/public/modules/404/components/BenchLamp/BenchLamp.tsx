...
import styles from './BenchLamp.module.css';
...
const BenchLamp = () => {
    return (
        ...
        <g id="lamp">
            ...
            {/* Light Gradient */}
            <defs>
            <radialGradient id="lightGradient" cx="119.676" cy="44.22" r="65" gradientUnits="userSpaceOnUse">
            ...
            {/* Lamp Glow */}
            <circle className={styles.lampGlow} fill="url(#lightGradient)" cx="119.676" cy="44.22" r="65" />
